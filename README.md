...
To view the html files in this repo (particular the figure generation files), prepend to the following URL including the https://  _https://html-preview.github.io/?url=_
